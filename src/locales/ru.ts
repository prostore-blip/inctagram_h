export const ru = {
  ...
  profile: {
    ...
    settings: {
      ...
      schema: {
        firstName: 'Имя должно содержать только буквы латинского алфавита или кириллицы',
        lastName: 'Фамилия должна содержать только буквы латинского алфавита или кириллицы',
        onlyLetters: 'Поле должно содержать только буквы латинского алфавита или кириллицы',
        userName:
          'Поле должно содержать только буквы русского и латинского алфавита и символы "_" или "-"',
        wrongDateFormat: 'дата должна быть в формате дд.ММ.ГГГГ',
      },
