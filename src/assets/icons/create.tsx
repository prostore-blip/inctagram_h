  ...
  return (
    ...
    >
      ...
      <g clipPath={'url(#clip301_4459)'}>
        ...
        <path
          d={
            'M15 11L13 11L13 9C13 8.73 12.89 8.48 12.7 8.29C12.51 8.1 12.26 8 12 8C11.73 8 11.48 8.1 11.29 8.29C11.1 8.48 11 8.73 11 9L11 11L9 11C8.73 11 8.48 11.1 8.29 11.29C8.1 11.48 8 11.73 8 12C8 12.26 8.1 12.51 8.29 12.7C8.48 12.89 8.73 13 9 13L11 13L11 15C11 15.26 11.1 15.51 11.29 15.7C11.48 15.89 11.73 16 12 16C12.26 16 12.51 15.89 12.7 15.7C12.89 15.51 13 15.26 13 15L13 13L15 13C15.26 13 15.51 12.89 15.7 12.7C15.89 12.51 16 12.26 16 12C16 11.73 15.89 11.48 15.7 11.29C15.51 11.1 15.26 11 15 11Z'
          }
          fill={'inherit'}
          fillOpacity={'1.000000'}
          fillRule={'nonzero'}
